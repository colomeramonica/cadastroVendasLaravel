...
class FillPermissionsForVendedore extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForVendedore constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.vendedore',
            'admin.vendedore.index',
            'admin.vendedore.create',
            'admin.vendedore.show',
            'admin.vendedore.edit',
            'admin.vendedore.delete',
            'admin.vendedore.bulk-delete',
        ]);
